...
<body>
	...
	<h4 class="text-center">Thank you for your order.<a href="${pageContext.request.contextPath}/orders/my-orders">
	click</a> here to check your orders.</h4> <!--<a href="${pageContext.request.contextPath}/orders/getPdf">
