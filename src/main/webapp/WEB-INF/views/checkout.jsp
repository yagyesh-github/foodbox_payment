			...
			<div class="checkout-left">
				<div class="address_form_agile mt-sm-5 mt-4">
					...
					<form action="${pageContext.request.contextPath}/order/checkout" method="post" class="creditly-card-form agileinfo_form">
							...
							<div class="information-wrapper">
								<div class="first-row">
									...
									<div class="w3_agileits_card_number_grids">
										...
										<div class="w3_agileits_card_number_grid_right form-group">
											<div class="controls">
											<label class="col-form-label"><b>Pin Code</b> [As of now product delivery for pin code 560001 is available.]</label>
												<input type="text" class="form-control" value="560001" maxlength="6" id="pinCode" name="pinCode" required="required" />
         			...
         			<input type="submit" id="submit" class="btn btn-success btn-md center-block" onclick="paymentStart()" value="${totalPrice}" style="width: 100px;" />
